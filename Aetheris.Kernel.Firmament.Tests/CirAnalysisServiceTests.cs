...
public sealed class CirAnalysisServiceTests
{
    ...
    {
        var plan = CompilePlan("fixtures/Compatibility/LegacyV1/Examples/box_basic.firmament");
    ...
    {
        var plan = CompilePlan("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cylinder_hole.firmament");
    ...
    {
        var plan = CompilePlan("fixtures/Compatibility/LegacyV1/Examples/rounded_corner_box_basic.firmament");
