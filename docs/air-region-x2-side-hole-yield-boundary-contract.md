...
The side-hole fixture is `fixtures/Firmament/Region/valid/side-hole-face-attached-region.valid.firmfixture`.
...
`fixtures/Firmament/Region/invalid/implicit-parent-mutation.invalid.firmfixture` still rejects direct parent mutation. X2 preserves the X1 rejection and adds diagnostics for missing explicit yield and missing boundary contract.
