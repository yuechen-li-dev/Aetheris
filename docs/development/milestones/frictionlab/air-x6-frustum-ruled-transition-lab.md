...
Aetheris V2 doctrine (resolved-profile-first, sweep-first, bounded analytic construction) explicitly lists `AirRuledTransition` as a bounded direction for compatible profile transitions. See `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md` (section 6.6).
