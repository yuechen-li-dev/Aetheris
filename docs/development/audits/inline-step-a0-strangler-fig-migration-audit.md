...
INLINE-STEP-X6:
  add metadata-only recognized-region evidence and semantic proposal records; see `docs/development/implementation/inline-step-x6-recognition-evidence-proposals.md`.
```
