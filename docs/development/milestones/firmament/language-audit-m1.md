...
- Canonical reference: `docs/development/history/firmament/preview2-reference/language-reference.md`
- Beginner path: `docs/development/history/firmament/preview2-reference/quickstart.md`
- Machine-readable status: `docs/development/milestones/firmament/language-features.json`
- Evidence matrices: `docs/development/milestones/firmament/language-audit-artifacts/language-audit-m1/`
