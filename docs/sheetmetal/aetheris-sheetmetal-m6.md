...
Two stale statements were corrected in place: `README.md` called all `.firmasm` deprecated, and `docs/assembly/assembly-m0.md` still said Assembly Template expansion and AP242 product export were absent. Both described older milestones.

## Canonical product source

The complete passing source is `fixtures/FirmamentV2/SheetMetal/m6-network-appliance-product.firmasm`. Its essential shape is:
