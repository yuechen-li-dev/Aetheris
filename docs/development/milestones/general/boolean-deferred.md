...
> Current architecture: see [Current authoring and kernel boundaries](../../architecture/system/current-authoring-and-kernel-boundaries.md). Central Boolean-family expansion is frozen unless real compatibility usage justifies a bounded family with an owner and migration plan; current product construction should prefer a Recipe.
...
- Wave 2a design note captured in `docs/development/milestones/frictionlab/W2A-boolean-mixed-blind-void-design.md` (2026-04-20); implementation remains deferred until bounded non-overlap mixed blind lane is scheduled.
