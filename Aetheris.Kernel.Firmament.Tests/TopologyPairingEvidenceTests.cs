...
public sealed class TopologyPairingEvidenceTests
{
    ...
    public void PairingEvidence_CoedgePairingDeferredWhenIdentityMissing()
    {
        ...
        Assert.Contains(result.Diagnostics, d => d.Contains("missing one-to-one identity", StringComparison.OrdinalIgnoreCase) || d.Contains("missing-identity", StringComparison.OrdinalIgnoreCase));
    }
