...
public sealed class InspectSelectionsTests
{
    ...
    public void InspectSelections_ReportsSourceGroundedClosedLoop()
    {
        ...
        var source = Path.Combine(root, "fixtures", "Regression", "Profile", "valid", "semantic-top-boundary-loop.firmament");
    ...
    {
        var root = FindRepoRoot();
        var source = Path.Combine(root, "fixtures", "Regression", "Hole", "valid", "construction-plane-through-hole.firmament");
        var stdout = new StringWriter(); var stderr = new StringWriter();
    ...
    {
        var root = FindRepoRoot();
        var source = Path.Combine(root, "fixtures", "Regression", "ProfileComposition", "valid", "construction-plane-blind-drill-clearance.firmament");
        var stdout = new StringWriter(); var stderr = new StringWriter();
