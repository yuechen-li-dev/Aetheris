...
- V2-A1 profile contract: `docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md`
- V2-X1 precursor: `docs/development/milestones/frictionlab/v2-x1-resolved-profile2d-lab.md`
