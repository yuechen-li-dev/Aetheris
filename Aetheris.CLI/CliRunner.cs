...
public static class CliRunner
{
    ...
    private static int RunSheetMetalCompare(string[] args, TextWriter stdout, TextWriter stderr)
    {
        ...
        if(json)stdout.WriteLine(JsonSerializer.Serialize(new{command="sheetmetal compare",success=comparison.Status is SheetMetalComparisonStatus.Pass or SheetMetalComparisonStatus.PassWithKnownDifferences or SheetMetalComparisonStatus.NeedsReview,source=sourcePath,intent=intentPath,comparison},JsonOptions));
