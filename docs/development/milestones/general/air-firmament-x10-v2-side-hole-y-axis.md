...
AIR-FIRMAMENT-X12 keeps the Y-axis routes unchanged and moves their route/frame/clearance facts into `FirmamentV2SideHoleRoutePolicy`; see `docs/development/milestones/general/air-firmament-x12-side-hole-route-policy.md`.
