...
- AIR docs: `docs/air-a0-atomic-intermediate-representation-kickoff.md`, `docs/air-a0-architecture-probe-report.md`.
- Sweep/profile-stack docs: `docs/frictionlab/cir-sweep-x0-profile-stack-extrude-lab.md`, `docs/cir-sweep-v1-profile-stack-extrude-executor.md`, `docs/cir-sweep-v2-cylindrical-hole-profile-stack-migration.md`.
