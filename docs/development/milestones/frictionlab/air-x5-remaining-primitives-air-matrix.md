...
Status note after AIR-V4: cylinder has now been production-routed via the proven AirRevolve lane (`docs/development/milestones/general/air-v4-cylinder-as-air-revolve-production.md`). Circular-profile AirExtrude remains blocked.

## References
- AIR-X3: `docs/development/milestones/general/air-x3-primitive-as-air-normalization-audit.md`
- AIR-X4: `docs/development/milestones/frictionlab/air-x4-box-as-air-extrude-lab.md`
- AIR-V3: `docs/development/milestones/general/air-v3-box-as-air-extrude-production.md`
