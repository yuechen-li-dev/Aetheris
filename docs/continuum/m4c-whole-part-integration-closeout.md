...
Deterministic JSON evidence is under `docs/continuum/artifacts/m4c/`, including benchmark summary, support/composition audits, all-orientation cell audits, worst cells, utility traces and ablation, orientation matrix, M4B comparison, fixed-vs-fine comparison, regressions, and hashes.
