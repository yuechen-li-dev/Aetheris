...
- EDGE-LOOP-A0: `docs/development/milestones/general/edge-loop-a0-face-boundary-edge-finish-audit.md`
- EDGE-LOOP-X1: `docs/development/milestones/frictionlab/edge-loop-x1-top-face-loop-chamfer-prismatic-lab.md`
- EDGE-A3 selection taxonomy: `docs/development/milestones/general/edge-a3-edge-finish-selection-taxonomy.md`
- Prismatic split policy: `docs/development/milestones/general/edge-prismatic-x4-coplanar-split-merge-policy-audit.md`
- Sweep-first doctrine: `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`
