...
- V2-A2 migration audit: `docs/v2-a2-prismatic-operation-migration-audit.md`
- V2-X8 parity lab: `docs/frictionlab/v2-x8-triangle-hex-prism-profile-parity-lab.md`
