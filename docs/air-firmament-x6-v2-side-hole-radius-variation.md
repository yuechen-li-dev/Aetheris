...
- `fixtures/FirmamentV2/Region/valid/side-hole-v2.valid.firmfixture` keeps canonical radius `1`.
- `fixtures/FirmamentV2/Region/valid/side-hole-radius-0_5-v2.valid.firmfixture` covers radius `0.5`.
- `fixtures/FirmamentV2/Region/valid/side-hole-radius-1_5-v2.valid.firmfixture` covers radius `1.5`.

Each valid fixture reaches `region-parent-integrated`, `Integrated`, `Closed`, `Succeeded`, with no blocker.

## Invalid radius fixtures

- `fixtures/FirmamentV2/Region/invalid/side-hole-radius-zero-v2.invalid.firmfixture` reports `firmament-v2-cylinder-radius-invalid`.
- `fixtures/FirmamentV2/Region/invalid/side-hole-radius-negative-v2.invalid.firmfixture` reports `firmament-v2-cylinder-radius-invalid`.
- `fixtures/FirmamentV2/Region/invalid/side-hole-radius-too-large-v2.invalid.firmfixture` reports `firmament-v2-side-hole-radius-exceeds-clearance`.
