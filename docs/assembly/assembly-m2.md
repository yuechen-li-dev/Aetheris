...
The historical proof is `testdata/step242/OCCT/as1.step`: 27 AP242 occurrences, five shared exact geometry definitions, 18 geometric leaf occurrences, and hierarchy depth three. The persisted M2 artifacts are under `docs/assembly/artifacts/m2/`.
