...
public sealed class FirmamentDocumentCoherenceValidationTests
{
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m2a-valid-two-primitives-distinct-ids.firmament");
    ...
    {
        var fixturePath = "fixtures/Compatibility/LegacyV1/Corpus/invalid/m2a-invalid-duplicate-id-across-primitive-boolean.firmament";
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m2a-valid-chained-features.firmament");
        Assert.True(result.Compilation.IsSuccess);
    }
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/p2_invalid_pattern_unknown_axis.firmament");
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/p2_invalid_pattern_source_primitive.firmament");
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/p3_invalid_pattern_mirror_plane.firmament");
    ...
    {
        var result = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/p3_invalid_pattern_mirror_source_placement.firmament");
    ...
    [Theory]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/invalid/m2a-invalid-add-to-missing-id.firmament", "add", "to", "missing")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/invalid/m2a-invalid-subtract-from-missing-id.firmament", "subtract", "from", "missing")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/invalid/m2a-invalid-intersect-left-missing-id.firmament", "intersect", "left", "missing")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/invalid/m2a-invalid-forward-reference.firmament", "add", "to", "later")]
