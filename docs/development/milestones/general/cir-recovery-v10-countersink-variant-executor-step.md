...
Superseded in part by `docs/development/milestones/general/cir-recovery-v11-countersink-cone-execution-step.md`, which resolves the prior cone-primitive blocker for a bounded countersink shape.
