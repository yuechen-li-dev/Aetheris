...
Fixture: `fixtures/FirmamentV2/InlineStep/valid/inline-step-v2-replace-through-hole-step-verified.valid.firmfixture`.

Input canonical STEP: `fixtures/FirmamentV2/InlineStep/testdata/canonical-through-hole.step`.
