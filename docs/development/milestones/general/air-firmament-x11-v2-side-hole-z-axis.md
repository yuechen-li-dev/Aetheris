...
AIR-FIRMAMENT-X12 consolidates the six X4-X11 controlled opposite-face side-hole routes into `FirmamentV2SideHoleRoutePolicy`; see `docs/development/milestones/general/air-firmament-x12-side-hole-route-policy.md` for the central route/frame/clearance table.
