...
public sealed class FirmamentSafeSubtractFeatureGraphValidationTests
{
    ...
    public void FeatureGraphValidator_Allows_CurrentCanonicalSafeChains()
    {
        var twoCylinder = FirmamentCorpusHarness.Compile(
            FirmamentCorpusHarness.ReadFixtureText("fixtures/LegacyV1/Examples/boolean_two_cylinder_holes_basic.firmament"));
        var cylinderCone = FirmamentCorpusHarness.Compile(
            FirmamentCorpusHarness.ReadFixtureText("fixtures/LegacyV1/Examples/boolean_cylinder_cone_holes_basic.firmament"));
    ...
    [Theory]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-composed-add-ordering.firmament", KernelDiagnosticCode.ValidationFailed, "Boolean feature 'joined' (add) cannot continue the safe subtract chain rooted at 'hole_a'", "firmament.feature-graph.invalid-composition-order")]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-overlapping-composed-holes.firmament", KernelDiagnosticCode.NotImplemented, "Boolean feature 'hole_b' (subtract) overlaps previously accepted hole <unknown>", "BrepBoolean.AnalyticHole.HoleInterference")]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-tangent-composed-holes.firmament", KernelDiagnosticCode.NotImplemented, "Boolean feature 'hole_b' (subtract) would be tangent to previously accepted hole <unknown>", "BrepBoolean.AnalyticHole.TangentContact")]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-composed-subtract-sphere.firmament", KernelDiagnosticCode.NotImplemented, "Boolean feature 'cavity' (subtract): Boolean Subtract does not support analytic tool surface kind 'Sphere' in the safe boolean family.", "BrepBoolean.UnsupportedAnalyticSurfaceKind")]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-composed-subtract-box.firmament", KernelDiagnosticCode.NotImplemented, "Boolean feature 'notch' (subtract): Boolean Subtract: bounded mixed through-void builder rejects tangent/edge-grazing analytic-prismatic interactions", "BrepBooleanBoxMixedThroughVoidBuilder.Build")]
    [InlineData("fixtures/LegacyV1/Corpus/deferred/m13a-unsupported-composed-subtract-straight-slot.firmament", KernelDiagnosticCode.NotImplemented, "Boolean feature 'slot_b' (subtract): Boolean Subtract: bounded mixed through-void builder rejects tangent/edge-grazing analytic-prismatic interactions", "BrepBooleanBoxMixedThroughVoidBuilder.Build")]
