...
public sealed class FirmamentStepExporterTests
{
    ...
    {
        var source = FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-valid-single-box-export.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-valid-placed-box-export.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-valid-placed-box-export.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-valid-boolean-export.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-valid-boolean-export.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cylinder_hole.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cylinder_hole.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cone_throughhole_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cone_throughhole_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_two_cylinder_holes_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_two_cylinder_holes_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_cylinder_cone_holes_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_cylinder_cone_holes_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_sphere_cavity_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_sphere_cavity_basic.firmament");
    ...
    {
        var boxSubtract = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_subtract_basic.firmament");
        var coneHole = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cone_throughhole_basic.firmament");
        var containedCylinder = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10h1-unsupported-box-with-cylinder-hole.firmament");
        var supportedSphereCavity = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/boolean_box_sphere_cavity_basic.firmament");
        var unsupportedTorus = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10n-unsupported-box-subtract-torus.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10h1-unsupported-box-with-cylinder-hole.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10h1-unsupported-box-with-cylinder-hole.firmament");
    ...
    public void FirmamentStepExporter_CirOnlyBoxCylinder_ExportsViaSemanticRecovery()
    {
        ...
        var source = FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Examples/boolean_box_cylinder_hole.firmament");
    ...
    {
        var compiler = new FirmamentCompiler();
        var source = FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10l-unsupported-box-subtract-sphere-touching-boundary.firmament");
        var compiled = compiler.Compile(new FirmamentCompileRequest(new FirmamentSourceDocument(source)));
        Assert.True(compiled.Compilation.IsSuccess);
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/m13b-invalid-composed-reenter-safe-family.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/m13b-invalid-composed-reenter-safe-family.firmament");
    ...
    [Theory]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10l-unsupported-box-subtract-sphere-touching-boundary.firmament", "tangent_cavity")]
    ...
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10l-unsupported-box-add-sphere.firmament", "joined")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10l-unsupported-box-intersect-sphere.firmament", "overlap")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10m-unsupported-box-subtract-cone.firmament", "tapered_cut")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10m-unsupported-box-add-cone.firmament", "joined")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10m-unsupported-box-intersect-cone.firmament", "overlap")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10n-unsupported-box-subtract-torus.firmament", "ring_cut")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10n-unsupported-box-add-torus.firmament", "joined")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m10n-unsupported-box-intersect-torus.firmament", "overlap")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m13a-unsupported-overlapping-composed-holes.firmament", "hole_b")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m13a-unsupported-tangent-composed-holes.firmament", "hole_b")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m13a-unsupported-composed-add-ordering.firmament", "joined")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m13a-unsupported-composed-subtract-sphere.firmament", "cavity")]
    [InlineData("fixtures/Compatibility/LegacyV1/Corpus/deferred/m13a-unsupported-composed-subtract-box.firmament", "notch")]
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10b-valid-schema-box-export.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10b-valid-schema-box-export.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cylinder_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cylinder_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/sphere_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/sphere_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/torus_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/torus_basic.firmament");
...
""";
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cone_frustum_basic.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cone_frustum_basic.firmament");
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cone_pointed_top_zero.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Examples/cone_pointed_top_zero.firmament");
    ...
    {
        var compile = CompileFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10h1-valid-mixed-primitive-boolean-validation.firmament");
...
""";
    ...
    {
        var first = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-no-export-body.firmament");
        var second = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/valid/m10a-no-export-body.firmament");
    ...
    {
        var result = ExportFixture("fixtures/Compatibility/LegacyV1/Corpus/invalid/m1a-invalid-sphere-missing-radius.firmament");
