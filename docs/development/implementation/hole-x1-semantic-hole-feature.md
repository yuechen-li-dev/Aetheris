...
HOLE-X2 adds an executable simple-shaft materialization lane for the scaffold introduced here. See `docs/development/implementation/hole-x2-simple-shaft-hole-materialization.md` for the bounded profile-stack/BRep route, provenance story, and remaining deferred hole-family scope.
