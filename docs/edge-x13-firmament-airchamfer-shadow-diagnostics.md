...
- EDGE-A1: `docs/edge-a1-chamfer-fillet-support-compatibility-matrix.md` defines CH-03 as the strongest AirChamfer row: convex plane-plane single-edge, controlled body, shadow/artifact/corpus supported, not production-authoritative.
- EDGE-V3: `docs/edge-v3-air-chamfer-shadow-route.md` defines `AirChamferShadowRoute`, the internal/test-only non-authoritative route used by this probe.
- EDGE-X10: `docs/frictionlab/edge-x10-airchamfer-cube-step-artifact.md` introduced the first CLI-visible controlled AirChamfer STEP artifact.
- EDGE-X11: `docs/frictionlab/edge-x11-airchamfer-step-artifact-corpus.md` introduced the tiny deterministic AirChamfer artifact corpus.
- EDGE-X12: `docs/frictionlab/edge-x12-airchamfer-corpus-stability.md` gated repeated-run corpus stability.
