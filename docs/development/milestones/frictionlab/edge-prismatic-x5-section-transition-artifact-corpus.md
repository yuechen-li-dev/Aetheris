...
- `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md` — V2 architecture doctrine.
- `docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md` — resolved `Profile2D` contract.
- `docs/development/milestones/general/edge-a2-constructive-chamfer-reframing-audit.md` — constructive chamfer reframing audit.
- `docs/development/milestones/general/edge-prismatic-a0-section-transition-contract-audit.md` — prismatic section-transition contract/audit.
- `docs/development/milestones/frictionlab/edge-prismatic-x1-section-transition-emitter-lab.md` — first lab emitter proof.
- `docs/development/milestones/frictionlab/edge-prismatic-x2-top-edge-chamfer-through-prismatic-emitter-lab.md` — top `+X` edge chamfer proof.
- `docs/development/milestones/frictionlab/edge-prismatic-x3-generic-line-profile-transition-lab.md` — generic equal-count polygon proof.
- `docs/development/milestones/general/edge-prismatic-v1-section-transition-emitter.md` — internal emitter seam.
- `docs/development/milestones/general/edge-prismatic-v2-controlled-top-edge-chamfer-route.md` — controlled top-edge chamfer route.
- `docs/development/milestones/general/edge-prismatic-x4-coplanar-split-merge-policy-audit.md` — split/merge policy; split preservation remains the default.
