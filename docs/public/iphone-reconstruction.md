...
The [smooth plateau witness](../../fixtures/Experiments/IPhone17ProMax/smooth-plateau-witness.firmament) deliberately fails with `section-chain-g1-degree-limit`. Current public profile authoring supplies lines/arcs; the G1 section-chain materializer requires polynomial normalization for arcs. G2, a refined body, and a refined-versus-blockout comparison are not delivered by this checkpoint.
