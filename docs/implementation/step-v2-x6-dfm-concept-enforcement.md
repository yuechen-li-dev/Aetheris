...
- `fixtures/FirmamentV2/Templates/invalid/template-v2-cnc-min-tool-radius-enforced.invalid.firmfixture`
- `fixtures/FirmamentV2/Templates/invalid/template-v2-concept-unit-mismatch-rejected-at-build.invalid.firmfixture`
...
```bash
dotnet run --project Aetheris.CLI -- build fixtures/FirmamentV2/Templates/invalid/template-v2-cnc-min-tool-radius-enforced.invalid.firmfixture --out "$tmp/template-v2-cnc-min-tool-radius.step" --json
```

```bash
dotnet run --project Aetheris.CLI -- build fixtures/FirmamentV2/Templates/invalid/template-v2-concept-unit-mismatch-rejected-at-build.invalid.firmfixture --out "$tmp/template-v2-concept-unit-mismatch.step" --json
```
