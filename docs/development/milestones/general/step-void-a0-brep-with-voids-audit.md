...
- Recovery/materialization context:
  - `docs/development/milestones/general/cir-recovery-v41-firmament-export-regression.md`
  - `docs/development/milestones/general/firmament-semantic-topology-naming.md`
- Related tests and fixtures:
  ...
  - `testdata/step242/golden/firmament-v1/boolean_box_cylinder_hole.step`
  - `testdata/step242/golden/firmament-v1/boolean_box_sphere_cavity_basic.step`
