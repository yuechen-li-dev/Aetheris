...
$publicExamples = @(
    'fixtures/Canonical/Integration/machined-mounting-block.firmament',
    'fixtures/Canonical/Features/Boss/boss-pocket-block.firmament',
    'fixtures/Canonical/PMI/hole-diameter-and-datum.firmament',
    'fixtures/Canonical/PMI/multiple-hole-dimensions-with-chamfer.firmament',
    ...
    'fixtures/Canonical/Templates/generic-mounting-plate.firmament',
    'fixtures/Canonical/Templates/cnc-dfm-policy.firmament',
    'fixtures/Canonical/Templates/fdm-dfm-policy.firmament',
    'fixtures/Canonical/Templates/sheet-metal-dfm-policy.firmament',
    'fixtures/Canonical/Profiles/concept-path-line-arc-profile.firmament',
    'fixtures/Canonical/Profiles/profile-delta-recess-extrusion.firmament',
    'fixtures/Canonical/FEA/cantilever.firmament',
    'fixtures/Canonical/FEA/inline-step-cantilever.firmament',
    'testdata/firmament/inline-step/canonical-through-hole.step',
    'fixtures/Canonical/Materials/material-catalog-coupon.firmament',
    'fixtures/Canonical/Primitives/pointed-cone.firmament',
    'fixtures/Canonical/Primitives/cone.firmament',
    'fixtures/Canonical/Primitives/sphere.firmament',
    'fixtures/Canonical/Primitives/torus.firmament',
    'fixtures/Canonical/FEA/material-resolved-cantilever.firmament',
    'fixtures/Canonical/Integration/inspection-block.firmament',
    'fixtures/Canonical/SheetMetal/sensor-bracket.firmament',
    'fixtures/Canonical/SheetMetal/four-wall-tray-template.firmament',
    'fixtures/Canonical/SheetMetal/profile-delta-tab-family.firmament',
    'fixtures/Canonical/SheetMetal/l-bracket-with-hole.firmament'
)
