...
> This document describes the legacy Firmament V1 placement model retained for compatibility and regression coverage. Firmament V2 is the current canonical authoring language; see [the serialization authority](../../architecture/system/firmament-serialization-compatibility.md).
