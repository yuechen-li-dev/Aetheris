...
AIR-REGION-X12 addresses the precise AIR-REGION-X11 blocker: `ShellClosure` for the metadata-driven controlled side-hole fixture at `fixtures/Firmament/Region/valid/side-hole-face-attached-region.valid.firmfixture`.
