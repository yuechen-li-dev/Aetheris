...
public sealed class FirmamentExamplePackSmokeTests
{
    ...
    [
        ...
        "fixtures/Compatibility/LegacyV1/Examples/rounded_corner_box_basic.firmament",
        "fixtures/Compatibility/LegacyV1/Examples/slot_cut_basic.firmament",
        "fixtures/Compatibility/LegacyV1/Examples/library_part_cube_with_hole_basic.firmament",
        ...
        "fixtures/Compatibility/LegacyV1/Examples/placed_primitive.firmament",
        "fixtures/Compatibility/LegacyV1/Examples/schema_box_basic.firmament"
    ];
    ...
    [Theory]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/box_basic.firmament", "base", 0, "primitive", "box")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/cylinder_basic.firmament", "post", 0, "primitive", "cylinder")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/cone_frustum_basic.firmament", "frustum1", 0, "primitive", "cone")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/cone_pointed_top_zero.firmament", "pointed1", 0, "primitive", "cone")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/sphere_basic.firmament", "ball", 0, "primitive", "sphere")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/torus_basic.firmament", "donut1", 0, "primitive", "torus")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/triangular_prism_basic.firmament", "tri1", 0, "primitive", "triangularprism")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/hexagonal_prism_basic.firmament", "hex1", 0, "primitive", "hexagonalprism")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/straight_slot_basic.firmament", "slot1", 0, "primitive", "straightslot")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/rounded_corner_box_basic.firmament", "rbox1", 0, "primitive", "roundedcornerbox")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/slot_cut_basic.firmament", "slot_cut_1", 0, "primitive", "slotcut")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/library_part_cube_with_hole_basic.firmament", "lib_part_1", 0, "primitive", "librarypart")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/box_add_basic.firmament", "joined", 1, "boolean", "add")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_add_basic.firmament", "joined", 2, "boolean", "add")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_subtract_basic.firmament", "carved", 2, "boolean", "subtract")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_intersect_basic.firmament", "overlap", 2, "boolean", "intersect")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_two_cylinder_holes_basic.firmament", "hole_b", 2, "boolean", "subtract")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_cylinder_cone_holes_basic.firmament", "cut_b", 2, "boolean", "subtract")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/boolean_box_sphere_cavity_basic.firmament", "cavity", 1, "boolean", "subtract")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/p2_mirror_hole_pair.firmament", "hole_cut_left__mir_yz", 2, "boolean", "subtract")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/placed_primitive.firmament", "post", 1, "primitive", "cylinder")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/schema_box_basic.firmament", "schema_box", 0, "primitive", "box")]
    ...
    {
        var result = FirmamentCorpusHarness.Compile(FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Examples/schema_box_basic.firmament"));
    ...
    [Theory]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/p1_blind_hole_on_face_semantic.firmament")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/p1_flange_radial_hole_semantic.firmament")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/w2_cylinder_root_blind_bore_semantic.firmament")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/w2_box_sphere_exterior_opening_pocket_semantic.firmament")]
    [InlineData("fixtures/Compatibility/LegacyV1/Examples/placed_primitive.firmament")]
