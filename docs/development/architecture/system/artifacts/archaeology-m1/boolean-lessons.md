...
1. `docs/development/architecture/kernel/brep-surgery.md`: contracts and low-level mechanics.
2. `docs/development/architecture/kernel/brep-boolean-lessons.md`: why Boolean looks simple; intersection versus topology; box/box; through and blind holes; counterbore; stepped N-level history; rotated/conic representation; prismatic/keyway; sphere; torus; recursive CIR; intent plus Surgery.
