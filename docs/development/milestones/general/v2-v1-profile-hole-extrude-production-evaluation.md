...
- Resolved profile contract (V2-A1): `docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md`
- V2-X1 lab: `docs/development/milestones/frictionlab/v2-x1-resolved-profile2d-lab.md`
- V2-X3 lab evidence: `docs/development/milestones/frictionlab/v2-x3-profile-with-hole-extrude-lab.md`
