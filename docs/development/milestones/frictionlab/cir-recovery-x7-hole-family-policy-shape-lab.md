...
- `docs/development/milestones/frictionlab/cir-brep-x5-frep-brep-recovery-policy-lab.md`
- `docs/development/milestones/frictionlab/cir-brep-x6-policy-shape-doe.md`
- `docs/development/milestones/general/cir-recovery-v5-policy-catalog.md`
- `docs/development/milestones/general/cir-recovery-v1b-through-hole-policy.md`
- `docs/development/milestones/general/surface-feature-a0-architecture-audit.md` through `surface-feature-a4-planar-groove-evidence.md`
- `docs/development/milestones/general/boolean-deferred.md`, `docs/development/milestones/general/groove-a0-bounded-revolved-groove-audit.md`
