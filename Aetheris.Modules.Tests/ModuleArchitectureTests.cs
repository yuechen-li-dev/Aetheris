...
public sealed class ModuleArchitectureTests
{
    [Fact] public void BuiltInsHaveStableIdentityVersionAndDeterministicOrder()
    {
        ...
        Assert.Equal(["Aetheris.Core","Aetheris.Humanoid","Aetheris.Piping","Aetheris.Surfacing","Aetheris.PlasticShell","Aetheris.SheetMetal"],first.Modules.Select(m=>m.Id.Value));
