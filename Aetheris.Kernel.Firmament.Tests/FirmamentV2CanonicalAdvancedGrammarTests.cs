...
public sealed class FirmamentV2CanonicalAdvancedGrammarTests
{
    ...
    [Theory]
    [InlineData("Patterns/record-array-slot-pattern.firmament", "CYLINDRICAL_SURFACE")]
    [InlineData("Templates/record-array-profile-family.firmament", "MANIFOLD_SOLID_BREP")]
    ...
    {
        var source = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Canonical", fixtureName));
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Canonical/Features/Slots/straight-slot.firmament"));
    ...
    [InlineData("Features/EdgeFinish/semantic-selection-chamfer.firmament", "OuterTopBoundary")]
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Canonical", fixtureName));
        var parse = FirmamentV2Parser.Parse(File.ReadAllText(path));
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Regression/CanonicalGeometry/profile-compose-l-bracket.firmament"));
        var parse = FirmamentV2Parser.Parse(File.ReadAllText(path));
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Canonical/PMI/counterbore-shaft-diameter.firmament"));
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Regression/CanonicalGeometry/profile-compose-l-bracket-external-modify-counterbore.firmament"));
    ...
    {
        var path = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Invalid/Geometry/profile-compose-l-bracket-edgefinish-unsupported.firmament"));
