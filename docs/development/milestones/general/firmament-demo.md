...
> This document describes the legacy Firmament V1 workflow retained for compatibility and regression coverage. Firmament V2 is the current canonical authoring language; see [the serialization authority](../../architecture/system/firmament-serialization-compatibility.md).
...
- `testdata/step242/golden/firmament-v1/box_with_hole.step`

## Step 3 — Open the generated STEP file

Open `testdata/step242/golden/firmament-v1/box_with_hole.step` in a STEP viewer or CAD tool that reads AP242.
