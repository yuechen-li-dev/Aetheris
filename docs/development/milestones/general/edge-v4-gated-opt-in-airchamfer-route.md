...
- EDGE-A1 compatibility matrix: `docs/development/milestones/general/edge-a1-chamfer-fillet-support-compatibility-matrix.md`
- EDGE-X13 Firmament shadow diagnostics: `docs/development/milestones/general/edge-x13-firmament-airchamfer-shadow-diagnostics.md`
- EDGE-V3 shadow route: `docs/development/milestones/general/edge-v3-air-chamfer-shadow-route.md`
- EDGE-V2 real-body prototype evidence: `docs/development/milestones/frictionlab/edge-x8-controlled-local-air-chamfer-topology-graft-lab.md` and subsequent AirChamfer corpus docs
