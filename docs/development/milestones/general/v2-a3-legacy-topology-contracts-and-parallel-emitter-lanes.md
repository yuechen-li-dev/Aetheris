...
Follow-up architecture audit reference: `docs/development/milestones/general/edge-a0-air-edge-sweep-fillet-chamfer-audit.md` (EDGE-A0 / V2-A4).
...
- Reference: `docs/development/milestones/frictionlab/edge-x1-chamfer-fillet-capability-matrix.md`.
