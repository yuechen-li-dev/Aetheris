...
The `docs/development/architecture/llm-cad-strategy` workflow materially helped. Its most useful instruction was to separate geometry inventory from modeling strategy and prefer a prismatic blockout/semantic dependency graph over copying final faces. It correctly prevented premature finish authoring and an arbitrary vendor-tree claim.
