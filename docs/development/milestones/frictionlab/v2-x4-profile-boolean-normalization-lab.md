...
- V2-A1 resolved contract: `docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md`
- V2-X1 profile contract lab: `docs/development/milestones/frictionlab/v2-x1-resolved-profile2d-lab.md`
- V2-X3 profile-hole extrusion lab: `docs/development/milestones/frictionlab/v2-x3-profile-with-hole-extrude-lab.md`
...
Update note (V2-X6): slot/capsule support is being evaluated in a dedicated lab (`docs/development/milestones/frictionlab/v2-x6-slot-capsule-profile-lab.md`) and remains out of production routing in V2-X4 scope.
