...
public static class ProfileEdgeFinishAnalyticPolicy
{
    ...
    [
        ...
        new("FilletConvexSharpSphere", c => Is(c, ProfileEdgeFinishKind.Fillet, ProfileEdgeFinishSourceFamily.SharpLineLine, ProfileEdgeFinishMaterialSide.Convex),
    ...
    private static ProfileEdgeFinishPlannerPolicy Create(ProfileEdgeFinishStationContext c, ProfileEdgeFinishRadiusRelation relation, string candidate, double utility, IReadOnlyList<string> rejected) => candidate switch
    {
        ...
        "FilletConvexSharpSphere" => Policy(c, relation, "ConvexSharpSphereJunctionPlan", ProfileEdgeFinishSurfaceFamily.Sphere, ProfileEdgeFinishRegularity.Regular, ProfileEdgeFinishAdmission.Supported, utility, rejected),
