...
FORGE-X2 promotes the FORGE-X1 `Standard.Hole` descriptor fixture into a built-in metadata-only Standard concept pack scaffold. See `docs/development/implementation/forge-x2-standard-concept-pack-scaffold.md` for the package-level descriptor, added concepts, and deferred runtime behavior.
