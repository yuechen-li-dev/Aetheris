...
| General smooth/rail/topology-changing loft, helix, and freeform surface features | Not in Preview 3 | Bounded G1 SectionChains do not qualify arbitrary smooth loft, guide rails, topology-changing correspondence, arbitrary dumb-solid editing, G2 continuity, or surface networks. |
