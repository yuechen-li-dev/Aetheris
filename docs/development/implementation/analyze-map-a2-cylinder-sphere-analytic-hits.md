...
Forward link: ANALYZE-MAP-A3 extends this analytic tier to cone and torus hits; see `docs/development/implementation/analyze-map-a3-cone-torus-analytic-hits.md`.
