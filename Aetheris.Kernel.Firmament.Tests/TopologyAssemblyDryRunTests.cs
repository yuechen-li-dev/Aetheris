...
public sealed class TopologyAssemblyDryRunTests
{
    ...
    {
        var result = TopologyAssemblyDryRunPlanner.Generate(new SdfSubtractNode(new SdfBoxNode(10, 10, 10), new SdfCylinderNode(2, 8)));
    ...
    {
        var result = TopologyAssemblyDryRunPlanner.Generate(new SdfSubtractNode(new SdfBoxNode(10, 10, 10), new SdfSphereNode(3)));
    ...
    {
        var result = TopologyAssemblyDryRunPlanner.Generate(new SdfSubtractNode(new SdfBoxNode(10, 10, 10), new SdfTorusNode(4, 1)));
    ...
    {
        var result = TopologyAssemblyDryRunPlanner.Generate(new SdfUnionNode(new SdfBoxNode(10, 10, 10), new SdfSphereNode(2)));
    ...
    {
        var node = new SdfSubtractNode(new SdfBoxNode(10, 10, 10), new SdfCylinderNode(2, 8));
