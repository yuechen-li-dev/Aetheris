...
- `determinism.json`: independent repeat-build hash comparison.
- `pdf-proof.json`: pypdf structural/searchability/font evidence.

Canonical quantities are Housing 3, Shaft 2, Spacer 4 (nine leaf Part occurrences). Both PDF authors and information-block authors are `CODEX`.
