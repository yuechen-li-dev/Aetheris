...
ledger are in `docs/development/milestones/reconstruction/ctc01-reconstruction-a1.md` and
...
The X4 investigation, feature ranking, Cadmata evidence, verification, and LLM-authoring friction log are in `docs/development/milestones/reconstruction/ctc01-llm-pressure-x4.md`.
