...
> V9 note: follow-up hardening for entry-side, translation, tolerance, and transform-rejection coverage is tracked in `docs/development/milestones/general/cir-recovery-v9-blind-hole-hardening.md`.
