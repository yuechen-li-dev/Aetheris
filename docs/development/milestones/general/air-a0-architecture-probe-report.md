...
### Docs inspected
- `docs/development/milestones/frictionlab/cir-sweep-x0-profile-stack-extrude-lab.md`
- `docs/development/milestones/general/cir-sweep-v1-profile-stack-extrude-executor.md`
- `docs/development/milestones/general/cir-sweep-v2-cylindrical-hole-profile-stack-migration.md`
- `docs/development/milestones/general/cir-recovery-v19-hole-family-capability-manifest.md`
- `docs/development/milestones/general/brep-boolean-stack-a0-stepped-root-cause.md`
- `docs/development/milestones/general/brep-boolean-stack-a1-nlevel-coaxial-validator.md`
- `docs/development/milestones/general/brep-boolean-stack-a2-stepped-downstream-blocker.md`
- `docs/development/milestones/general/brep-boolean-stack-a4-stepped-repeated-subtract-productionization.md`
...
- `docs/development/milestones/general/step-void-a0-brep-with-voids-audit.md`
- `docs/development/milestones/general/step-void-a1-brep-with-voids-import.md`
- `docs/development/milestones/general/step-void-a2-solid-root-export-planner.md`
- `docs/development/milestones/general/firmament-semantic-topology-naming.md` (SEM-A0)
- `docs/development/milestones/general/groove-a0-bounded-revolved-groove-audit.md`
