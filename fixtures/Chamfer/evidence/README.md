...
`hole-entry-fixed.step` is the corrected compatibility authority. CAD Assistant imports and renders the analytic conical entry and cylindrical shaft. See `docs/development/implementation/hole-entry-occt-interop-a0.md`.
