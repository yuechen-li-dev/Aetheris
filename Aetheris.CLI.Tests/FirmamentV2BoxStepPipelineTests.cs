...
{
    private static readonly string FixturePath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Regression/Primitive/valid/pipeline-v2-box-step-verified.valid.firmfixture"));
