...
- EDGE-PRISMATIC-A0: `docs/development/milestones/general/edge-prismatic-a0-section-transition-contract-audit.md`.
- EDGE-PRISMATIC-X1: `docs/development/milestones/frictionlab/edge-prismatic-x1-section-transition-emitter-lab.md`.
- EDGE-PRISMATIC-X2: `docs/development/milestones/frictionlab/edge-prismatic-x2-top-edge-chamfer-through-prismatic-emitter-lab.md`.
- EDGE-PRISMATIC-X3: `docs/development/milestones/frictionlab/edge-prismatic-x3-generic-line-profile-transition-lab.md`.
- EDGE-PRISMATIC-V1: `docs/development/milestones/general/edge-prismatic-v1-section-transition-emitter.md`.
- V2 sweep-first architecture: `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`.
- Resolved Profile2D contract: `docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md`.
- Constructive chamfer reframing audit: `docs/development/milestones/general/edge-a2-constructive-chamfer-reframing-audit.md`.
