...
{
    private static string FixturePath => Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../fixtures/Compatibility/LegacyV1/Examples/hexbolt_template_m2.firmament"));
