...
internal static class FirmamentKnownOpKinds
{
    private static readonly IReadOnlyDictionary<string, FirmamentKnownOpKind> Registry =
        new Dictionary<string, FirmamentKnownOpKind>(StringComparer.Ordinal)
        {
            ...
            ["rounded_corner_box"] = FirmamentKnownOpKind.RoundedCornerBox,
            ["slot_cut"] = FirmamentKnownOpKind.SlotCut,
            ["library_part"] = FirmamentKnownOpKind.LibraryPart,
            ...
            ["chamfer"] = FirmamentKnownOpKind.Chamfer,
            ["fillet"] = FirmamentKnownOpKind.Fillet,
    ...
    public static FirmamentOpFamily ClassifyFamily(FirmamentKnownOpKind kind) =>
        kind switch
        {
            ...
            FirmamentKnownOpKind.RoundedCornerBox => FirmamentOpFamily.Primitive,
            FirmamentKnownOpKind.SlotCut => FirmamentOpFamily.Primitive,
            FirmamentKnownOpKind.LibraryPart => FirmamentOpFamily.Primitive,
            ...
            FirmamentKnownOpKind.Chamfer => FirmamentOpFamily.Boolean,
            FirmamentKnownOpKind.Fillet => FirmamentOpFamily.Boolean,
