...
public sealed record FirmamentV2RegionTraceSummary(string Name, string Kind, string On, string OnKind, string ResolvedOn, string OnRefType, string Operation, string Tool, double Radius, FirmamentV2FaceLocalPoint2D? Center, string Through, string ThroughKind, string ResolvedThrough, string ThroughRefType);
