...
- `docs/development/milestones/general/air-cir-a0-authority-and-mirror-contract.md` for the AIR/CIR/BRep authority boundary and topology-loss guardrails;
- `docs/development/milestones/general/air-cir-x1-mirror-metadata-prototype.md` for `CirMirrorAdmissionService`, `CirMirrorStatus`, `CirMirrorCapability`, and primitive/prismatic admission vocabulary;
- `docs/development/milestones/general/cir-map-x1-primitive-map-prototype.md` for the CIR tape-backed primitive map evaluator and BRep raycast summary baseline;
- `docs/development/milestones/general/cir-m0-design.md` and `docs/development/milestones/general/cir-e0-evaluation-runtime.md` for CIR node/tape evaluation context.
