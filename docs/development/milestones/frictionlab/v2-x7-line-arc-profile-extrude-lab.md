...
Aligned to V2 doctrine (`docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`) and V2-A1 resolved profile contract (`docs/development/milestones/general/aetheris-v2-a1-resolved-profile2d-contract.md`).
