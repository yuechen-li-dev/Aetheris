...
| `Aetheris.Kernel.Firmament.Tests/*Hole*`, `Aetheris.FrictionLab.Tests/CIRLab/*Hole*`, and docs such as `docs/development/milestones/general/cir-recovery-v12-hole-family-coverage-matrix.md`, `docs/development/milestones/general/cir-recovery-v13-stepped-hole-variant-executor-step.md`, `docs/development/milestones/general/cir-recovery-v14-stepped-hole-corpus-hardening.md`, `docs/development/milestones/general/cir-recovery-v19-hole-family-capability-manifest.md` | test-only / documentation-only | These provide reusable corpus, expected behavior, and capability notes. They should be mined for promotion tests after a production semantic hole scaffold exists. |
