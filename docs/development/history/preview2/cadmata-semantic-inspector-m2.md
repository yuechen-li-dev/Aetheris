...
Browser evidence is under `docs/development/history/preview2/evidence/cadmata-m2/`. Imported AP242 PMI, exhaustive STEP entity IDs, broad Pattern/EdgeFinish coverage, and TemplateInstance UI remain intentionally deferred.
