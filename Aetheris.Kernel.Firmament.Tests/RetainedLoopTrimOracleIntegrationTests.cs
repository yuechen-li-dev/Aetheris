...
public sealed class RetainedLoopTrimOracleIntegrationTests
{
    ...
    {
        var result = FacePatchCandidateGenerator.Generate(new SdfSubtractNode(new SdfBoxNode(10,10,10), new SdfCylinderNode(2,20)));
    ...
    {
        var result = FacePatchCandidateGenerator.Generate(new SdfSubtractNode(new SdfBoxNode(10,10,10), new SdfSphereNode(6)));
    ...
    {
        var result = FacePatchCandidateGenerator.Generate(new SdfSubtractNode(new SdfBoxNode(12,12,12), new SdfTorusNode(4,1)));
    ...
    {
        var root = new SdfSubtractNode(new SdfBoxNode(10,10,10), new SdfUnionNode(new SdfCylinderNode(2,20), new SdfCylinderNode(2,20)));
    ...
    {
        var report = MaterializationReadinessAnalyzer.Analyze(new SdfSubtractNode(new SdfBoxNode(10,10,10), new SdfCylinderNode(2,20)));
