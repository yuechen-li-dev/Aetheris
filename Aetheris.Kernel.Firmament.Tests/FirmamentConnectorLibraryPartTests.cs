...
public sealed class FirmamentConnectorLibraryPartTests
{
    ...
    {
        var source = FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Examples/library_part_cube_with_hole_basic.firmament");
    ...
    {
        var source = FirmamentCorpusHarness.ReadFixtureText("fixtures/Compatibility/LegacyV1/Examples/composed_part_with_slot.firmament");
