...
| `docs/boolean-deferred.md` and milestone notes | historical record | retain; add forward links/context rather than rewriting outcomes |

## Documentation cleanup map

| Documents | Classification/action |
|---|---|
| `docs/firmament-v2/language-reference.md` | canonical/current; conflicting `.firmasm` sentence corrected in M1 |
| `Aetheris.Kernel.Firmament/README.md` | severely stale pre-M0 scaffold claim; update in M1 |
| `docs/firmament-overview.md`, `firmament-language-shape.md`, `firmament-build-workflow.md`, `firmament-demo.md`, `firmament-author-rules.md`, `firmament-selectors.md`, `firmament-placement-semantics.md` | historical V1 docs that often say “current” or “canonical”; add a shared historical banner in M2, retain content for compatibility |
| `docs/air-firmament-a1-firmament-fixture-corpus.md` | directionally correct but says V1 remains valid; update wording to explicit compatibility/serialization destination in M2 |
| `docs/build-test-policy-net10-and-legacy-v1.md` | current and consistent; retain |
| `docs/assembly/artifacts/m0/*`, assembly milestone docs | retain historical; link to current profile distinction |
| `testdata/firmasm/*/README.md` | update to say legacy JSON compatibility fixture |
| `docs/boolean-deferred.md` | current truthful scope statement; retain and link to freeze policy |
