...
- AIR/CIR/BRep authority and mirror contract: `docs/air-cir-a0-authority-and-mirror-contract.md`.
- AIR/CIR mirror metadata: `docs/air-cir-x1-mirror-metadata-prototype.md`.
- CIR map prototype: `docs/cir-map-x1-primitive-map-prototype.md`.
- Mirror-aware primitive map dispatch: `docs/cir-map-x2-mirror-aware-primitive-map-dispatch.md`.
- Prismatic mirror feasibility: `docs/cir-prismatic-x1-prismatic-mirror-feasibility.md`.
- Convex polyhedron mirror implementation: `docs/cir-prismatic-x2-convex-polyhedron-mirror.md`.
- Analyze-map audit recommending hybrid dispatch: `docs/edge-prismatic-x7-analyze-map-cir-frep-audit.md`.
- X5/X6 corpus and analyzer evidence: `docs/frictionlab/edge-prismatic-x5-section-transition-artifact-corpus.md` and `docs/frictionlab/edge-prismatic-x6-corpus-stability-and-analyzer-confirmation.md`.
