...
- `docs/development/milestones/frictionlab/v2-x1-resolved-profile2d-lab.md`
- `docs/development/milestones/frictionlab/v2-x6-slot-capsule-profile-lab.md`
- `docs/development/milestones/frictionlab/v2-x7-line-arc-profile-extrude-lab.md`
- `docs/development/milestones/general/v2-v1-profile-hole-extrude-production-evaluation.md`
- `docs/development/milestones/general/v2-v2-profile-hole-extrude-through-hole-integration.md`
- `docs/development/milestones/general/v2-v4-line-arc-profile-extrude-production-evaluation.md`
...
See: `docs/development/milestones/general/v2-a3-legacy-topology-contracts-and-parallel-emitter-lanes.md`.
