...
* `fixtures/FirmamentV2/PMI/valid/pmi-v2-hole-diameter-callout-emits-in-step.valid.firmfixture`
* `fixtures/FirmamentV2/PMI/valid/pmi-v2-datum-plane-emits-in-step.valid.firmfixture`
...
```bash
aetheris build fixtures/FirmamentV2/PMI/valid/pmi-v2-hole-diameter-callout-emits-in-step.valid.firmfixture --out <tmp>/pmi-v2-hole-diameter.step --json
aetheris build fixtures/FirmamentV2/PMI/valid/pmi-v2-datum-plane-emits-in-step.valid.firmfixture --out <tmp>/pmi-v2-datum-plane.step --json
```
...
This implements the optional Tier 6 entries in `docs/mvp/firmament-v2-ap242-mvp-readiness-contract.md`: `pmi-v2-hole-diameter-callout-emits-in-step` and `pmi-v2-datum-plane-emits-in-step`. PMI remains non-MVP-required unless a pitch/demo explicitly requires annotated AP242 output.
