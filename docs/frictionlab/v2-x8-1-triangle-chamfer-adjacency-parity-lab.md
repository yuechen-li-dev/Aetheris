...
| Case | Legacy body produced | Candidate body produced | Topology summary parity | Adjacency summary parity | Legacy chamfer admissibility | Candidate chamfer admissibility | First divergence | Blocker classification | Recommendation |
|---|---|---|---|---|---|---|---|---|---|
| triangle-basic | true | true | false | false | admissible (1/1) | rejected (0/1) | `adjacency:topology-count-mismatch` | `adjacency-parity` | `triangle-feature-recognition-needs-adjacency-parity` |
| triangle-non-orth-chamfer | true | true | false | false | admissible (1/1) | rejected (0/1) | `adjacency:topology-count-mismatch` | `adjacency-parity` | `triangle-feature-recognition-needs-adjacency-parity` |
| triangle-alt | true | true | false | false | admissible (1/1) | rejected (0/1) | `adjacency:topology-count-mismatch` | `adjacency-parity` | `triangle-feature-recognition-needs-adjacency-parity` |

Values above are from deterministic `TrianglePrismChamferAdjacencyParityLab.RunAll()` output with the current implementation.
