...
- EDGE-PROFILE-X2: `docs/development/milestones/frictionlab/edge-profile-x2-top-edge-chamfer-profile-stack-lab.md`
- EDGE-PRISMATIC-X1: `docs/development/milestones/frictionlab/edge-prismatic-x1-section-transition-emitter-lab.md`
- Prismatic contract audit: `docs/development/milestones/general/edge-prismatic-a0-section-transition-contract-audit.md`
- Sweep-first architecture doctrine: `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`
