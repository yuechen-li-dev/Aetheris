...
- Native AP242 product structure is not emitted. The current exporter creates one PRODUCT/PRODUCT_DEFINITION and one shape representation per body and has no NAUO, mapped-item, or representation-relationship-with-transformation writer. See `docs/development/milestones/assembly/artifacts/m1/ap242-audit.md`.
