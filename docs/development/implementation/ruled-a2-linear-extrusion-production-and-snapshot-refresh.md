...
For follow-on ruled/swept experimentation, RULED-TOOLING-A0 adds an InlineStep-based probe harness so developers can wrap a small probe asset instead of hand-authoring a full fixture; see `docs/development/implementation/ruled-tooling-a0-inline-step-probe-harness.md`.
