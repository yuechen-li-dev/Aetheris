...
## References
- EDGE-V2: `docs/development/milestones/general/edge-v2-real-body-air-chamfer-prototype.md`
- EDGE-X9: `docs/development/milestones/frictionlab/edge-x9-air-chamfer-feature-recognition-parity-lab.md`
- EDGE-V3: `docs/development/milestones/general/edge-v3-air-chamfer-shadow-route.md`
- V2 sweep-first architecture: `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`
- Legacy topology / parallel emitter lanes: `docs/development/milestones/general/v2-a3-legacy-topology-contracts-and-parallel-emitter-lanes.md`
- AirEdgeSweep audit: `docs/development/milestones/general/edge-a0-air-edge-sweep-fillet-chamfer-audit.md`
