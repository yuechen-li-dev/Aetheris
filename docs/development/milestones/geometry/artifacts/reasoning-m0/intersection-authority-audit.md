...
No code change was needed in these paths. The architecture rule is now explicit in `docs/development/milestones/geometry/reasoning.md` and the new public query does not call any BRep or trim materializer.
