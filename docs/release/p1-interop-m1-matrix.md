...
| --- | --- | --- | --- |
| Analyze | `fixtures/FirmamentV2/InlineStep/testdata/canonical-through-hole.step`; `aetheris analyze --json` | pass | Sequential IDs are contiguous and expose raw STEP traceability; `Source.Face(7)` is authoring vocabulary, not `ADVANCED_FACE #…`. |
