...
Update: AIR-FIRMAMENT-X10 extends the controlled side-hole route set to Y-axis opposite faces; see `docs/development/milestones/general/air-firmament-x10-v2-side-hole-y-axis.md`.
