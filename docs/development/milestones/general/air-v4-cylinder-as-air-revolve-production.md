...
## Context
AIR-V4 follows the Aetheris V2 sweep-first doctrine (`docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`) and the primitive-as-AIR normalization direction from AIR-X3 (`docs/development/milestones/general/air-x3-primitive-as-air-normalization-audit.md`).

AIR-X5 evidence (`docs/development/milestones/frictionlab/air-x5-remaining-primitives-air-matrix.md`) established that:
...
## AIR-V5.1 follow-up
- CLI external validation coverage for AIR-routed cylinder behavior was added in `docs/development/milestones/general/air-v5-1-cli-validation.md`.
