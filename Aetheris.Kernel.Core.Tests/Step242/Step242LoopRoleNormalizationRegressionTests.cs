...
public sealed class Step242LoopRoleNormalizationRegressionTests
{
    ...
    public void Step242_CylinderLoopRole_ProjectionDiagnostics_AreDeterministic_AndExplicit(string relativePath, bool expectDiagnostics, bool expectDegeneracy)
    {
