...
- V2-X1: `docs/development/milestones/frictionlab/v2-x1-resolved-profile2d-lab.md`
- V2-X3: `docs/development/milestones/frictionlab/v2-x3-profile-with-hole-extrude-lab.md`
- V2-X4: `docs/development/milestones/frictionlab/v2-x4-profile-boolean-normalization-lab.md`
- V2-V1: `docs/development/milestones/general/v2-v1-profile-hole-extrude-production-evaluation.md`
- V2-V2: `docs/development/milestones/general/v2-v2-profile-hole-extrude-through-hole-integration.md`
- V2-X5/V2-V3 lab chain: `docs/development/milestones/frictionlab/v2-v3-profile-boolean-to-extrude-pipeline.md`
