...
SEM-A0 guardrails remain preserved (`docs/development/milestones/general/firmament-semantic-topology-naming.md`): this milestone adds no generated topology naming and no new selector/provenance exposure.
