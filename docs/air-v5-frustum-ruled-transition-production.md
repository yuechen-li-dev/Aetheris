...
## Context and lineage
- V2 doctrine: `docs/aetheris-v2-sweep-first-architecture.md` defines bounded transition/sweep-first policy and keeps analytic admissibility explicit.
- AIR-X5 matrix: `docs/frictionlab/air-x5-remaining-primitives-air-matrix.md` marked cone/frustum as viable but conservative for production migration.
- AIR-X6 lab: `docs/frictionlab/air-x6-frustum-ruled-transition-lab.md` proved non-apex frustum parity through a ruled-transition representation with conical analytic classification.
