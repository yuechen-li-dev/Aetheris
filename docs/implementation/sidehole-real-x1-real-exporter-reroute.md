...
```text
fixtures/FirmamentV2/Region/valid/feature-v2-side-hole-step-verified.valid.firmfixture
```
...
```bash
dotnet run --project Aetheris.CLI -f net10.0 -- build fixtures/FirmamentV2/Region/valid/feature-v2-side-hole-step-verified.valid.firmfixture --out "$tmp/feature-v2-side-hole.step" --json
```
