...
The complete qualified example is [`box-holes-pmi-chamfer.firmament`](../../../fixtures/FirmamentV2/Canonical/valid/box-holes-pmi-chamfer.firmament):

```powershell
aetheris validate fixtures/FirmamentV2/Canonical/valid/box-holes-pmi-chamfer.firmament --json
aetheris build fixtures/FirmamentV2/Canonical/valid/box-holes-pmi-chamfer.firmament --output artifacts/pmi.step --json
