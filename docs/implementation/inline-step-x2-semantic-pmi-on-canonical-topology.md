...
* `fixtures/FirmamentV2/InlineStep/valid/inline-step-v2-datum-pmi-on-canonical-face-emits-in-step.valid.firmfixture`
* `fixtures/FirmamentV2/InlineStep/valid/inline-step-v2-hole-diameter-pmi-on-canonical-face-emits-in-step.valid.firmfixture`
