...
Follow-up: DISPLAY-QA-X2 fixed the FTC-06 imported-body framing defect and promoted mixed/partial display status into the main UI. See [docs/development/milestones/general/display-qa-x2-imported-body-framing-status.md](/C:/Users/yuech/source/repos/Aetheris/docs/development/milestones/general/display-qa-x2-imported-body-framing-status.md).
