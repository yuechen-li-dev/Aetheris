...
> Current architecture: see [Current authoring and kernel boundaries](../../architecture/system/current-authoring-and-kernel-boundaries.md). This older package sketch is retained for historical context and is not the current authoring/kernel authority.
...
- Until M06, analytic geometry primitives remain separate from topology entities; binding/association is intentionally deferred.
