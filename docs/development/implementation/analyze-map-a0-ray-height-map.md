...
ANALYZE-MAP-A1 refactors the ray path to analytic-first backend dispatch with per-hit provenance and explicit tessellated fallback diagnostics. See `docs/development/implementation/analyze-map-a1-analytic-backend-provenance.md`.
