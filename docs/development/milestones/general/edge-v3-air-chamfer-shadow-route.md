...
## References
- V2 architecture doctrine: `docs/development/milestones/general/aetheris-v2-sweep-first-architecture.md`
- Legacy topology / parallel lane doctrine: `docs/development/milestones/general/v2-a3-legacy-topology-contracts-and-parallel-emitter-lanes.md`
...
EDGE-A1 now defines the full chamfer/fillet support taxonomy, compatibility rows, and production-readiness gates in `docs/development/milestones/general/edge-a1-chamfer-fillet-support-compatibility-matrix.md`. EDGE-V3 remains non-authoritative shadow evidence for controlled AirChamfer rows; it is one readiness input, not proof of full support or production route replacement.
