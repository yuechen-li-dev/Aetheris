...
Primary context documents: `docs/development/scope-contracts/v2/aetheris-v2-phase1-scope-contract.md`, `docs/development/scope-contracts/v2/firmament-v2-concept-template-syntax-reconciliation.md`, and the L1/L2/L3/L4/F1/P1/R1/P2 implementation notes under `docs/development/implementation/`.
