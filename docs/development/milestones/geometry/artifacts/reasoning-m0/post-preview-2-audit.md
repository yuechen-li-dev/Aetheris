...
```text
dotnet run --project Aetheris.CLI -- validate docs/development/milestones/geometry/artifacts/reasoning-m0/historical-panel-only.firmament
dotnet run --project Aetheris.CLI -- build docs/development/milestones/geometry/artifacts/reasoning-m0/historical-panel-only.firmament --out docs/development/milestones/geometry/artifacts/reasoning-m0/historical-panel-only.step
```
