...
- **Representative artifacts saved:**
  - `docs/development/reports/artifacts/analyze-map-ftc09/ftc09-six-view-16x16.json` (~66 KiB)
  - `docs/development/reports/artifacts/analyze-map-ftc09/ftc09-six-view-32x32.json` (~74 KiB)
  - `docs/development/reports/artifacts/analyze-map-ftc09/ftc09-point-probes.json` (~25 KiB)
...
ANALYZE-MAP-A5 was proposed from this dogfood report to turn compact-grid topology into measured connected components and suggested point probes. See `docs/development/implementation/analyze-map-a5-components-and-probes.md`.

## Phase closeout

The first LLM-oriented analyze-map phase closeout summarizes this dogfood result alongside CTC-01 and RULED-A2 in `docs/development/reports/analyze-map-phase-closeout-a0.md`.
