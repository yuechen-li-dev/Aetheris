...
- EDGE-PRISMATIC-X8 hybrid dispatch: `docs/development/milestones/general/edge-prismatic-x8-hybrid-map-dispatch-prismatic-mirror.md`
- CIR-PRISMATIC-X2 convex polyhedron mirror: `docs/development/milestones/general/cir-prismatic-x2-convex-polyhedron-mirror.md`
- CIR map/mirror dispatch background: `docs/development/milestones/general/cir-map-x1-primitive-map-prototype.md` and `docs/development/milestones/general/cir-map-x2-mirror-aware-primitive-map-dispatch.md`
- AIR/CIR authority and mirror contract: `docs/development/milestones/general/air-cir-a0-authority-and-mirror-contract.md`
