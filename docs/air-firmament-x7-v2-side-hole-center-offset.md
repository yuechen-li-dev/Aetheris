...
- `fixtures/FirmamentV2/Region/valid/side-hole-center-y1-v2.valid.firmfixture`
- `fixtures/FirmamentV2/Region/valid/side-hole-center-z1-v2.valid.firmfixture`
- `fixtures/FirmamentV2/Region/valid/side-hole-center-y1-z1-v2.valid.firmfixture`

## Invalid center fixtures

- `fixtures/FirmamentV2/Region/invalid/side-hole-center-y-boundary-v2.invalid.firmfixture`
- `fixtures/FirmamentV2/Region/invalid/side-hole-center-z-boundary-v2.invalid.firmfixture`
- `fixtures/FirmamentV2/Region/invalid/side-hole-center-arity-one-v2.invalid.firmfixture`
- `fixtures/FirmamentV2/Region/invalid/side-hole-center-arity-three-v2.invalid.firmfixture`
