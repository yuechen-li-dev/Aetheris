...
`artifacts/local/evidence/preview2/surface-mesh-ir-m6/ctc-01-metrics.json`.
...
```text
dotnet run --project Aetheris.CLI -- mesh testdata/step242/nist/CTC/nist_ctc_01_asme1_ap242-e1.stp --format obj --output artifacts/local/evidence/preview2/surface-mesh-ir-m6/ctc-01.obj --debug-ir artifacts/local/evidence/preview2/surface-mesh-ir-m6/ctc-01-surface-mesh-ir.json --json
dotnet run --project Aetheris.CLI -- mesh testdata/step242/nist/CTC/nist_ctc_01_asme1_ap242-e1.stp --format stl --output artifacts/local/evidence/preview2/surface-mesh-ir-m6/ctc-01.stl --json
```
