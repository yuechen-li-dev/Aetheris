...
public sealed class SheetMetalM1Tests
{
    ...
    {
        var path=Path.Combine(RepoRoot,"fixtures/FirmamentV2/SheetMetal/simple-u-channel.firmament");
    ...
    public void Ctc03_RecoversToleranceBoundedThicknessAndBendEvidenceDeterministically()
    {
        ...
        Assert.Equal(15,first.Part!.Regions.Count);Assert.Equal(7,first.Part.Bends.Count);Assert.Equal(2,first.Part.Features.Count);Assert.Equal(first.Part.StableId,second.Part!.StableId);
    ...
    {
        var authored=SheetMetalFirmament.CompileFile(Path.Combine(RepoRoot,"fixtures/FirmamentV2/SheetMetal/simple-u-channel.firmament"));
    ...
    {
        var authored=SheetMetalFirmament.CompileFile(Path.Combine(RepoRoot,"fixtures/FirmamentV2/SheetMetal/simple-u-channel.firmament"));var part=authored.Part!;
