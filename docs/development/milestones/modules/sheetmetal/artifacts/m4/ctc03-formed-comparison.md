...
CTC-03 remains independently constructed from `docs/development/milestones/modules/sheetmetal/artifacts/m2/ctc03-idiomatic.firmament`; no source STEP, evidence provider, raw face ID, or recovered region polygon is required for construction.
