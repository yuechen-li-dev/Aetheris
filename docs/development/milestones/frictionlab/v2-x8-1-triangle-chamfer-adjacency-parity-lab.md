...
## Update note (V2-X8.2)
A deterministic first-delta forensic audit now lives at `docs/development/milestones/frictionlab/v2-x8-2-triangle-adjacency-delta-audit.md`, replacing coarse blocker wording with concrete mismatch category/payload evidence.
