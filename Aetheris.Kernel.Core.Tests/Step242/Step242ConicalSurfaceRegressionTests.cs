...
public sealed class Step242ConicalSurfaceRegressionTests
{
    ...
    [InlineData("testdata/step242/nist/CTC/nist_ctc_04_asme1_ap242-e1.stp", "importer-topology", "Importer.LoopRole.InnerNotContained", "Inner loop is not contained by outer loop.")]
