...
- AIR-X3 audit (`docs/development/milestones/general/air-x3-primitive-as-air-normalization-audit.md`) concluded primitive-as-AIR normalization is viable and recommended box as first migration candidate.
- AIR-X4 lab (`docs/development/milestones/frictionlab/air-x4-box-as-air-extrude-lab.md`) validated rectangle-profile linear extrusion parity against pre-migration `CreateBox` behavior.
...
## AIR-V5.1 follow-up
- CLI external validation coverage for AIR-routed box behavior was added in `docs/development/milestones/general/air-v5-1-cli-validation.md`.
